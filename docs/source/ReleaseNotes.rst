...
Появился метод для парсинга Уведомления Об Уточнении (УОУ) для счетов-фактур и УПД: :doc:`ParseInvoiceCorrectionRequestXml <http/ParseInvoiceCorrectionRequestXml>`
